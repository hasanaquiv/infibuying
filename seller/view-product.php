  ...
  <div class="app-content content">
    <div class="content-wrapper">
	  ...
	  <?php $counts = $data->counts($search);
			...
			$p = $page * $limit;
			if(empty($_REQUEST['p'])){
	echo '<script>window.location = "view-product?p=1&search=";
 </script>';
}
	  ?>
            ...
            <div class="row">			                                    
                ...
                <div class="form-group col-md-12">
				  ...
				  <nav aria-label="Page navigation">
					...
					<?php 
                     echo ' <li class="page-item"><a class="page-link" href="view-product?p=1&search='.$search.'">First</a></li>';
                      if($_REQUEST['p']>1){$prev_page = $_REQUEST['p']-1;
						echo '<li class="page-item"><a class="page-link" href="view-product?p='.$prev_page.'&search='.$search.'">Prev</a></li>';} else {echo '<li class="page-item"><a class="page-link" href="#">Prev</a></li>';}
						$link = $count/$limit;
						$link = ceil($link);
						$check = $p + $limit;
						$_REQUEST['p']+'3'."<br>";
						...
						if($check>15){
							...
							echo ($a==$_REQUEST['p']) ? '<li class="page-item active"><a class="page-link" href="#">'.$a.'</a></li>' : '<li class="page-item"><a class="page-link" href="view-product?p='.$a.'&search='.$search.'">&nbsp;'.$a.'</a></li>';
						} }  else {
							for($a=1 ; $a<=$l; $a++){
							echo ($a==$_REQUEST['p']) ? '<li class="page-item active"><a class="page-link" href="#">'.$a.'</a></li>' : '<li class="page-item"><a class="page-link" href="view-product?p='.$a.'&search='.$search.'">&nbsp;'.$a.'</a></li>';
						}
						...
						echo '<li class="page-item"><a class="page-link" href="view-product?p='.$next_page.'&search='.$search.'">Next</a></li>';} else {echo '<li class="page-item"><a class="page-link" href="#">Next</a></li>';}
					  echo ' <li class="page-item"><a class="page-link" href="view-product?p='.$link.'&search='.$search.'">Last</a></li>';
...
function delete_data(id)
{
 ...
 {
  window.location='view-product.php?id='+id;
 }
}
</script>
  <?php 
		...
		@$id=$_GET['id']; 
		$delete = $data->del($id);
		echo ($delete)?'<script>alert("delete");</script>':'<script>alert("not");</script>';
		}
  ?>